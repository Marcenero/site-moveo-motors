                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 font-bold text-gray-500">
                            ...
                            <li><a href="#servicos" className="hover:text-[#D9A300] transition-colors">Financiamento</a></li>
                            <li><a href="#" className="hover:text-[#D9A300] transition-colors">Avaliação Online</a></li>
                            <li><a href="#contato" className="hover:text-[#D9A300] transition-colors">Localização</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 font-bold text-gray-500">
                            ...
                            <li><a href="#" className="hover:text-[#D9A300] transition-colors">Trabalhe Conosco</a></li>
